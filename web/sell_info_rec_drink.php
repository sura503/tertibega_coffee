...
<div>
 ...
 <div class="navbar">
  <a href="sell_info_rec_food.php"  >Tertibegna Foods </a>
  <a href="sell_info_rec_drink.php" id="active-nv">Tertibega Drinks </a>
...
<br/>
<br/>
<center> <h2> Tertibega Coffee Drink Order Selection Page </h2> </center>
...
$sql = "SELECT ProductID,ProductName FROM product_list_rec where Product_Type=1 ORDER BY ProductID ASC";
...
$conn->close();
	 ...
	 ?> 
      ...
      <div class="add-item" >
        ...
        <input type="number" id="Tot_ammount"  required min="1" name="Tot_ammount" placeholder="Amount" required />
      </div>
                  <br/>
                  <br/>
		 <div class="add-item">
