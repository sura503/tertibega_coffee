...
<div class="container">
  <h2> Today's Drink Beverage Products Sales History </h2>
  <ul class="responsive-table">
    <li class="table-header">
      <div class="col col-1">Product Name</div>
       <div class="col col-3"> Order Count </div>
...
if ($result->num_rows > 0) {
	...
	echo " <li class='table-row'>"; 
     ...
     echo  "<div class='col col-2' data-label='Order Count'>". htmlspecialchars($row["TotalQuantitySold"]) . " Order </div>";
...
if ($profit_result && $profit_result->num_rows > 0) {
	...
	echo "<h4 style='text-align:right;padding-right:20%;'>Today's Drinks Total Income: ". number_format($today_profit, 2). " ETB </h3>";
