...
$Sql_Weekly=" SELECT
  ...
  MIN(SaleDate) AS Month_Start_Date,
  MAX(SaleDate) AS Month_End_Date,
...
<br/>
<div class="container">
  <h2> Monthly Products Sales Report </h2>
  <br/>
  <ul class="responsive-table">
    <li class="table-header">
      <div class="col col-1">Year</div>
      <div class="col col-2">Month</div>
      <div class="col col-2">Month Start Date</div>
...
<?php		  
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<div class='col col-2' data-label='Week Start Date'>".htmlspecialchars($row["Month"])."</div>";
      echo "<div class='col col-3' data-label='Week End Date'>". htmlspecialchars($row["Month_Start_Date"])."</div>";
      echo "<div class='col col-3' data-label='Week End Date'>". htmlspecialchars($row["Month_End_Date"])."</div>";
