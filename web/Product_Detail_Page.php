...
$sql=" 
SELECT * from  product_list_rec where Product_Type = 2 order by Product_Type,Catagory";
...
<div class="container">
  <h2>Tertibega Coffee Product's <small>Foods </small></h2>
  <br/>
...
<?php
   ...
   while ($row = mysqli_fetch_assoc($result)) {
     ...
     if($row["Prodcut_State"] == 1 )
	 {
		 $Prodcut_State= "Available";
	 }
	 else
	 {
		$Prodcut_State= "Not Available"; 
	 }
    ...
    //while($row = $result->fetch_assoc()) {
     ...
     echo "<div class='col col-4' data-label='Product Type'>" . htmlspecialchars($Product_Type) . " </div>";
      echo "<div class='col col-5' data-label='Prodcut State'>" . htmlspecialchars($Prodcut_State) . " </div>";
     echo "</li>";
    }
    echo "</table> </center>";
	?>
