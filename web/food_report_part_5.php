...
<?php
	...
	echo " <li class='table-row'>"; 
     ...
     echo  "<div class='col col-2' data-label='Date'>". htmlspecialchars($row["Seles_On"]) . "</div>";
      echo "<div class='col col-3' data-label='Total Order'>". htmlspecialchars($row["Quantity"]) . " Order</div>";
      echo "<div class='col col-4' data-label='Unit Price'>" . htmlspecialchars($row["Unit_Price"])  . " ETB </div>";
      echo "<div class='col col-5' data-label='Total Price'>". htmlspecialchars($row["TotalSeles"]) . " ETB</div>";
       echo " </li> ";
    }
  echo " </ul> </div>";
